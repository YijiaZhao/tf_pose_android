//
// Created by kimi on 2020/7/26.
//
#include "com_example_mnistandroid_pafprocess.h"
...
JNIEXPORT jint JNICALL Java_com_example_mnistandroid_pafprocess_process_1paf
        (JNIEnv *env, jobject jobj, jint p1, jint p2, jint p3, jfloatArray peaks_, jint h1, jint h2, jint h3, jfloatArray heatmap_, jint f1, jint f2, jint f3, jfloatArray pafmap_){
    float* peaks = (float *)env->GetFloatArrayElements(peaks_, 0);
    float* heatmap = (float *)env->GetFloatArrayElements(heatmap_, 0);
    float* pafmap = (float *)env->GetFloatArrayElements(pafmap_, 0);
//    LOG.
...
JNIEXPORT jint JNICALL Java_com_example_mnistandroid_pafprocess_get_1part_1cid
        (JNIEnv *env, jobject jobj, jint human_id, jint part_id){
...
JNIEXPORT jfloat JNICALL Java_com_example_mnistandroid_pafprocess_get_1score
        (JNIEnv *env, jobject jobj, jint human_id){
...
JNIEXPORT jint JNICALL Java_com_example_mnistandroid_pafprocess_get_1part_1x
        (JNIEnv *env, jobject jobj, jint cid){
